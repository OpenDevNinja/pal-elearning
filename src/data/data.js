...
const bannerData = [
  {
    id: "banner-1",
    topText: "EDUCATION WORDPRESS THEME",
    titleText: "BUILD YOUR DREAM WITH EDUMAN",
    bottomText: "",
    buttonLink: "/",
  ...
  {
    id: "banner-2",
    topText: "Platform Eduman",
    titleText: "Build Your Own Online",
    bottomText: "Free for physically handcraft / Course certificate ",
    buttonLink: "/",
    buttonText: "How to apply",
  ...
  {
    id: "banner-3",
    topText: "Skills you need today",
    titleText: " for a successful tomorrow",
    bottomText: "Learn/ practice / succeed ",
    buttonLink: "/",
    buttonText: "How to apply",
...
const footerData = [
  ...
  },
  {
    ...
    title: "Location",
    lists: [
      { text: "support@pal.com" },
      { text: "Highland Strett, A04 Street 4014" },
      { text: "Abomey-Calavi, Bénin" },
      { text: "Phone: +229 66 47 67 60" },
    ],
  },
];
