...
import courseInstractorImg from '../../assets/img/courses/course-instructors.webp';
        ...
        <div className="course-instructors">
            ...
            <div className="instructors-heading">
                <div className="instructors-img w-img"> 
                    <Link to="/instructor-profile"><img src={courseInstractorImg} style={{width:'100%', height:'auto'}} alt="img not found"/></Link>
                </div>
