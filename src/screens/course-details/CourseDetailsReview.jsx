...
import courseReviewImg from "../../assets/img/courses/course-reviews-3.png";
import courseReviewImgTwo from "../../assets/img/courses/course-reviews-2.png";
import courseReviewImgThree from "../../assets/img/courses/course-reviews-1.png";
import { Link } from "react-router-dom";

const CourseDetailsReview = () => {
  return (
    <div className="course-detalis-reviews pt-15">
      <div className="course-detalis-reviews-tittle mt-5">
        <h3>Reviews</h3>
      </div>
      <div className="course-review-item mb-30">
        <div className="course-reviews-img">
          <Link href="#">
          <img src={courseReviewImgThree} style={{width:'auto', height:'auto'}} alt="img not found"/>
          </Link>
        </div>
      ...
      <div className="course-review-item mb-30">
        <div className="course-reviews-img">
          <Link href="#">
          <img src={courseReviewImgTwo} style={{width:'auto', height:'auto'}} alt="img not found"/>
          </Link>
        </div>
        <div className="course-review-list">
          <h5>
      ...
      <div className="course-review-item mb-30">
        <div className="course-reviews-img">
          <Link href="#">
          <img src={courseReviewImg} style={{width:'auto', height:'auto'}} alt="img not found"/>
          </Link>
        </div>
        <div className="course-review-list">
          <h5>
